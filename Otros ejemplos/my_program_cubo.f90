program my_program_cubo
    ...
    data%camp_y =[1, -1, 1, -1, 1, -1, 1, -1] 
    data%camp_z =[0, 0, 0, 0, 0, 0, 0, 0] 
    ...
    ! Compilar  ->  gfortran -I./VTKFortran/static/mod my_program_cubo.f90 memoria.o file_managment.o -L./VTKFortran/static -l vtkfortran -o my_program_cubo


end program my_program_cubo