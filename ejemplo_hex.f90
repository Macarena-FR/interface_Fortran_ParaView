program ejemplo_hex
    ...
    data%camp_x =[1.0, 1.0, -0.9178, -0.9178, 1.0, -0.9048, -0.9048] 
    data%camp_y =[0, 0, 0, 0, 0, 0, 0] 
    data%camp_z =[-1.0, -1.0, 0.9178, 0.9178, -1.0, 0.9048, 0.9048] 
